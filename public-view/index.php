...
<html lang="en-US" dir="ltr">
  ...
  <head>
    ...
    <!--    Document Title-->
    <!-- ===============================================-->
    <title>courier | M&P &amp; GLOBAL </title>
        ...
        <div class="container"><a class="navbar-brand" href="index.php"><img src="assets/img/gallery/logo.png" height="45" alt="logo" /></a>
          ...
          <div class="collapse navbar-collapse border-top border-lg-0 mt-4 mt-lg-0" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto pt-2 pt-lg-0 font-base">
              ...
              <li class="nav-item px-2"><a class="nav-link" href="track.php">Track parcel</a></li>
            </ul>
            ...
            </div><a class="btn btn-primary order-1 order-lg-0 ms-lg-3" href="#contactus">Contact Us</a>
            <a class="btn btn-primary order-1 order-lg-0 ms-lg-3" href="logout.php"> click here to logout </a>
        ...
        <div class="container">
          <div class="row align-items-center">
            ...
            <div class="col-md-75 col-xl-6 col-xxl-5 text-md-start text-center py-8">
              ...
              <p class="fs-1 mb-5">We deliver your products safely to <br />your home in a reasonable time. </p><a class="btn btn-primary me-2" href="index.php" role="button">Get started<i class="fas fa-arrow-right ms-2"></i></a>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="track parcel">
        <div class="container">
          <div class="row">
            ...
            <div class="col-lg-6">
              <h5 class="text-primary mb-3">Enter Tracking Number </h5>
              <form class="row gx-2 gy-2 align-items-center">
                <div class="col">
                  ...
                  <div class="input-group-icon">
                    <input type="search" id="ref_no" class="form-control input-box form-quriar-control text-light" placeholder="Type the tracking number here">
